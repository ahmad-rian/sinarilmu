...
const About = () => {
  ...
  return (
    <div className="w-full bg-white dark:bg-gray-900 pt-16" style={{ minHeight: '100vh', overflowX: 'hidden', overflowY: 'auto' }}>
          ...
          >
            ...
            >
              <div className="mb-3 sm:mb-4 lg:mb-6">
                <h2 className="text-sm sm:text-base lg:text-lg xl:text-2xl font-bold text-gray-800 dark:text-gray-200 font-heading mb-2 sm:mb-3 lg:mb-4">Program Pengabdian Masyarakat</h2>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-6 xl:gap-8">
            {stats.map((stat, index) => (
              ...
              >
                <div className="bg-gradient-to-br from-gray-50 to-primary-50 dark:from-gray-800 dark:to-gray-700 rounded-xl lg:rounded-2xl p-3 sm:p-4 lg:p-6 xl:p-8 border border-gray-200/50 dark:border-gray-700/50 hover:border-primary-300/50 dark:hover:border-primary-600/50 transition-all duration-300 shadow-lg hover:shadow-xl">
                  <h3 className="text-lg sm:text-xl lg:text-2xl xl:text-3xl 2xl:text-4xl font-bold font-heading bg-gradient-to-r from-primary-600 to-secondary-600 bg-clip-text text-transparent mb-1 lg:mb-2">
                    {stat.number}
                  </h3>
                  <p className="text-gray-700 dark:text-gray-300 font-bold font-heading mb-0 lg:mb-1 text-xs sm:text-sm lg:text-base">
                    {stat.label}
                  </p>
                  <p className="text-gray-500 dark:text-gray-400 text-xs lg:text-sm font-body">
                    {stat.subtitle}
                  </p>
                </div>
              </motion.div>
            ...
            {values.map((value, index) => (
              ...
              >
                <div className="bg-white dark:bg-gray-800 rounded-xl lg:rounded-2xl xl:rounded-3xl p-4 sm:p-6 lg:p-8 shadow-lg border border-gray-100 dark:border-gray-700 hover:border-primary-200 dark:hover:border-primary-700 hover:shadow-xl transition-all duration-500 h-full">
                  <div className="mb-3 sm:mb-4 lg:mb-6">
                    <span className="inline-block px-2 sm:px-3 lg:px-4 py-1 lg:py-2 bg-gradient-to-r from-primary-50 to-secondary-50 dark:from-primary-900/20 dark:to-secondary-900/20 text-primary-700 dark:text-primary-300 text-xs lg:text-sm font-semibold rounded-full border border-primary-200/50 dark:border-primary-700/50">
                      {value.highlight}
                    </span>
                  </div>
          ...
          <div className="grid gap-4 sm:gap-6 lg:gap-8 lg:grid-cols-2 xl:grid-cols-3">
            {teamMembers.map((member, index) => (
              <motion.div
                ...
                className="group"
              >
                <div className="bg-white dark:bg-gray-800 rounded-xl lg:rounded-2xl xl:rounded-3xl p-4 sm:p-6 lg:p-8 shadow-lg border border-gray-100 dark:border-gray-700 group-hover:border-primary-200 dark:group-hover:border-primary-700 group-hover:shadow-xl transition-all duration-500">
                  <div className="text-center mb-3 sm:mb-4 lg:mb-6">
                    {/* Profile Image */}
                    <div className="w-16 h-16 sm:w-18 sm:h-18 lg:w-20 lg:h-20 xl:w-24 xl:h-24 bg-gradient-to-br from-primary-100 to-secondary-100 dark:from-primary-900/30 dark:to-secondary-900/30 rounded-xl lg:rounded-2xl flex items-center justify-center mx-auto mb-2 sm:mb-3 lg:mb-4 overflow-hidden">
                      <img 
                        src={member.image} 
                        alt={member.name}
                      ...
                      <div className="w-full h-full bg-gradient-to-br from-primary-400 to-secondary-400 hidden items-center justify-center">
                        <span className="text-white font-bold text-sm sm:text-base lg:text-lg xl:text-xl 2xl:text-2xl">{member.name.split(' ').map(n => n[0]).join('')}</span>
                      </div>
                    </div>
                    
                    <h3 className="text-sm sm:text-base lg:text-lg xl:text-xl font-bold font-heading text-gray-900 dark:text-white mb-1">
                      {member.name}
                    </h3>
                    <p className="text-primary-600 dark:text-primary-400 font-bold font-body text-xs lg:text-sm mb-1">
                      {member.nim}
                    </p>
                    <p className="text-secondary-600 dark:text-secondary-400 font-semibold font-heading text-xs sm:text-sm lg:text-base mb-1 lg:mb-2">
                      {member.role}
                    </p>
                    <p className="text-gray-500 dark:text-gray-400 font-body text-xs lg:text-sm mb-3 lg:mb-4">
                      {member.specialty}
                    </p>
                  </div>
                  
                  <div className="mb-3 sm:mb-4 lg:mb-6">
                    <p className="text-gray-600 dark:text-gray-400 font-body text-xs lg:text-sm leading-relaxed mb-2 sm:mb-3 lg:mb-4">
                      {member.description}
                    </p>
                    ...
                    <div className="flex flex-wrap gap-1 sm:gap-2">
                      {member.skills.map((skill, skillIndex) => (
                        <span
                          key={skillIndex}
                          className="px-2 lg:px-3 py-0.5 lg:py-1 bg-gradient-to-r from-primary-50 to-secondary-50 dark:from-primary-900/20 dark:to-secondary-900/20 text-primary-700 dark:text-primary-300 text-xs font-medium font-body rounded-full border border-primary-200/50 dark:border-primary-700/50"
                        >
                          {skill}
                        </span>
                      ))}
              ...
              {milestones.map((milestone, index) => (
                ...
                >
                  <div className={`flex-1 w-full ${index % 2 === 0 ? "lg:pr-8" : "lg:pl-8"} mb-3 lg:mb-0`}>
                    <div className={`bg-white dark:bg-gray-800 rounded-xl lg:rounded-2xl p-4 sm:p-6 lg:p-8 shadow-lg border-0 hover:shadow-xl transition-all duration-300 ${
                      milestone.status === 'current' ? 'ring-2 ring-primary-500/50 border-primary-300 dark:border-primary-600' : ''
                    }`}>
                      <div className="flex flex-wrap items-center gap-2 lg:gap-3 mb-3 sm:mb-4 lg:mb-6">
                      ...
                      <h3 className="text-sm sm:text-base lg:text-lg xl:text-2xl font-bold font-heading text-gray-900 dark:text-white mb-2 sm:mb-3 lg:mb-4">
                        {milestone.title}
                      </h3>
                      <p className="text-gray-600 dark:text-gray-400 font-body text-xs sm:text-sm lg:text-base leading-relaxed mb-2 sm:mb-3 lg:mb-4">
                        {milestone.description}
                      </p>
                      
                      {/* Insights */}
                      <div className="bg-gradient-to-r from-primary-50 to-secondary-50 dark:from-primary-900/20 dark:to-secondary-900/20 rounded-lg lg:rounded-xl p-2 sm:p-3 lg:p-4 border-l-4 border-primary-400">
                        <p className="text-xs lg:text-sm text-gray-700 dark:text-gray-300 font-body italic">
                  ...
                  <div className="relative z-10 my-3 lg:my-0">
                    <div className={`w-4 h-4 lg:w-5 lg:h-5 xl:w-6 xl:h-6 rounded-full border-4 border-white dark:border-gray-900 ${
      ...
      {/* University Section */}
      <section className="py-8 sm:py-12 lg:py-16 xl:py-24 relative">
        {/* Background */}
        <div className="absolute inset-0 bg-gradient-to-br from-primary-600 to-primary-800">
          <div className="absolute top-4 sm:top-8 lg:top-16 right-4 sm:right-8 lg:right-20 w-24 h-24 sm:w-32 sm:h-32 lg:w-48 lg:h-48 xl:w-96 xl:h-96 bg-white/5 rounded-full blur-2xl"></div>
          <div className="absolute bottom-4 sm:bottom-8 lg:bottom-16 left-4 sm:left-8 lg:left-20 w-20 h-20 sm:w-28 sm:h-28 lg:w-40 lg:h-40 xl:w-80 xl:h-80 bg-secondary-400/10 rounded-full blur-2xl"></div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <motion.div
            ...
            transition={{ duration: 0.8 }}
          >
            <h2 className="text-xl sm:text-2xl lg:text-4xl xl:text-6xl font-bold font-heading text-white mb-3 sm:mb-4 lg:mb-6 xl:mb-8 px-2">
              Universitas Jenderal Soedirman
            </h2>
            <p className="text-sm sm:text-base lg:text-xl text-white/90 font-body max-w-xs sm:max-w-2xl lg:max-w-4xl xl:max-w-5xl mx-auto mb-6 sm:mb-8 lg:mb-10 xl:mb-12 leading-relaxed px-4">
            ...
            <div className="grid gap-4 sm:gap-6 lg:gap-8 lg:grid-cols-3 max-w-xs sm:max-w-2xl lg:max-w-3xl xl:max-w-4xl mx-auto">
              <motion.div
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                transition={{ delay: 0.1 }}
                className="bg-white/10 backdrop-blur-xl rounded-xl lg:rounded-2xl p-4 sm:p-6 lg:p-8 border border-white/20"
              >
                <h3 className="text-lg sm:text-xl lg:text-2xl xl:text-3xl font-bold font-heading text-white mb-1 lg:mb-2">1963</h3>
                <p className="text-white/80 font-body text-xs sm:text-sm lg:text-base">Tahun Berdiri</p>
              </motion.div>
              <motion.div
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
                ...
                className="bg-white/10 backdrop-blur-xl rounded-xl lg:rounded-2xl p-4 sm:p-6 lg:p-8 border border-white/20"
              >
                <h3 className="text-lg sm:text-xl lg:text-2xl xl:text-3xl font-bold font-heading text-white mb-1 lg:mb-2">Purwokerto</h3>
                <p className="text-white/80 font-body text-xs sm:text-sm lg:text-base">Jawa Tengah</p>
              </motion.div>
              <motion.div
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
                ...
                className="bg-white/10 backdrop-blur-xl rounded-xl lg:rounded-2xl p-4 sm:p-6 lg:p-8 border border-white/20"
              >
                <h3 className="text-lg sm:text-xl lg:text-2xl xl:text-3xl font-bold font-heading text-white mb-1 lg:mb-2">UNSOED</h3>
                <p className="text-white/80 font-body text-xs sm:text-sm lg:text-base">Akronim</p>
              </motion.div>
            </div>
          </motion.div>
        </div>
      ...
      <section className="py-8 sm:py-12 lg:py-16 xl:py-24 bg-white dark:bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-sm sm:text-base lg:text-xl text-gray-600 dark:text-gray-400 font-body max-w-xs sm:max-w-2xl lg:max-w-3xl xl:max-w-4xl mx-auto mb-6 sm:mb-8 lg:mb-10 xl:mb-12 leading-relaxed px-4">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 lg:gap-6 justify-center items-center mb-6 sm:mb-8 lg:mb-12 xl:mb-16 px-4">
              <motion.button
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
                onClick={() => navigate('/help/contact')}
                className="w-full sm:w-auto px-6 sm:px-8 lg:px-10 py-3 sm:py-4 lg:py-5 bg-gradient-to-r from-primary-600 to-primary-700 text-white font-bold font-heading text-sm sm:text-base lg:text-lg rounded-xl lg:rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300"
              >
                Hubungi Kami
              </motion.button>
              ...
              <motion.button
                ...
                className="w-full sm:w-auto px-6 sm:px-8 lg:px-10 py-3 sm:py-4 lg:py-5 border-2 border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 hover:border-primary-400 font-bold font-heading text-sm sm:text-base lg:text-lg rounded-xl lg:rounded-2xl backdrop-blur-sm bg-white/50 dark:bg-gray-800/50 hover:bg-white/80 dark:hover:bg-gray-800/80 transition-all duration-300 shadow-lg"
              >
                Gabung Komunitas
              </motion.button>
            </div>
            ...
            {/* Contact Cards */}
            <div className="grid gap-4 sm:gap-6 lg:gap-8 lg:grid-cols-3 max-w-xs sm:max-w-2xl lg:max-w-5xl xl:max-w-6xl mx-auto">
              <motion.div
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                ...
                className="group"
              >
                <div className="bg-gradient-to-br from-gray-50 to-primary-50 dark:from-gray-800 dark:to-gray-700 rounded-xl lg:rounded-2xl p-4 sm:p-6 lg:p-8 border border-gray-200/50 dark:border-gray-700/50 hover:border-primary-300/50 dark:hover:border-primary-600/50 transition-all duration-300 shadow-lg hover:shadow-xl h-full">
                  <div className="mb-3 sm:mb-4 lg:mb-6">
                    <div className="w-10 h-10 sm:w-12 sm:h-12 lg:w-14 lg:h-14 xl:w-16 xl:h-16 bg-gradient-to-br from-primary-100 to-primary-200 dark:from-primary-900/30 dark:to-primary-800/30 rounded-xl lg:rounded-2xl flex items-center justify-center mx-auto">
                      <span className="text-lg sm:text-xl lg:text-2xl font-bold text-primary-600 dark:text-primary-400">💬</span>
                    </div>
                  </div>
                  <h3 className="text-sm sm:text-base lg:text-lg xl:text-xl font-bold font-heading text-gray-900 dark:text-white mb-2 sm:mb-3 lg:mb-4">
                    Diskusi Program
                  </h3>
                  <p className="text-gray-600 dark:text-gray-400 font-body text-xs sm:text-sm lg:text-base leading-relaxed">
              ...
              <motion.div
                ...
                className="group"
              >
                <div className="bg-gradient-to-br from-gray-50 to-secondary-50 dark:from-gray-800 dark:to-gray-700 rounded-xl lg:rounded-2xl p-4 sm:p-6 lg:p-8 border border-gray-200/50 dark:border-gray-700/50 hover:border-secondary-300/50 dark:hover:border-secondary-600/50 transition-all duration-300 shadow-lg hover:shadow-xl h-full">
                  <div className="mb-3 sm:mb-4 lg:mb-6">
                    <div className="w-10 h-10 sm:w-12 sm:h-12 lg:w-14 lg:h-14 xl:w-16 xl:h-16 bg-gradient-to-br from-secondary-100 to-secondary-200 dark:from-secondary-900/30 dark:to-secondary-800/30 rounded-xl lg:rounded-2xl flex items-center justify-center mx-auto">
                      <span className="text-lg sm:text-xl lg:text-2xl font-bold text-secondary-600 dark:text-secondary-400">🎓</span>
                    </div>
                  </div>
                  <h3 className="text-sm sm:text-base lg:text-lg xl:text-xl font-bold font-heading text-gray-900 dark:text-white mb-2 sm:mb-3 lg:mb-4">
